...
import getYearMonthArray from "./getYearMonthArray";

export const getCurrencyFromDate = async (date) => {
...
export const getCurrencyFormDateRange = async (firstDate, lastDate) => {
