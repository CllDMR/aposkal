...
const testimonials = [
  [
    {
      content:
        "Aposkal is so easy to use I can’t help but wonder if it’s really doing the things the government expects me to do.",
      author: {
        name: "Sheryl Berge",
  ...
  [
    {
      content:
        "The best part about Aposkal is every time I pay my employees, my bank balance doesn’t go down like it used to. Looking forward to spending this extra cash when I figure out why my card is being declined.",
      author: {
        name: "Leland Kiehn",
    ...
    {
      content:
        "There are so many things I had to do with my old software that I just don’t do at all with Aposkal. Suspicious but I can’t say I don’t love it.",
      author: {
        name: "Erin Powlowski",
  ...
  [
    {
      content:
        "I used to have to remit tax to the EU and with Aposkal I somehow don’t have to do that anymore. Nervous to travel there now though.",
      author: {
        name: "Peter Renolds",
