...
interface AcıkRızaBeyanıProps {
  displayName: string;
}

export const AcıkRızaBeyanı: FC<AcıkRızaBeyanıProps> = ({ displayName }) => {
  const sellerCompany = {
  ...
  return (
    <>
      ...
      <p className="text-sm font-bold text-gray-800">Ad Soyad:{displayName}</p>
    </>
  );
};
