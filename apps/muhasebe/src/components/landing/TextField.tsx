  ...
  ({ id, name, label, type = "text", placeholder, ...props }, ref) => {
    return (
      <input
        ...
        className={
          "focus:border-blue-500 focus:ring-blue-500 block w-full appearance-none rounded-md border border-gray-200 bg-gray-50 px-3 py-2 text-gray-900 placeholder-gray-400 focus:bg-white focus:outline-none sm:text-sm"
        }
        {...props}
      />
    );
