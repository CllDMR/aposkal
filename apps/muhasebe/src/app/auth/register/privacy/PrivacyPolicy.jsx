    ...
    <>
      <div className="privacy-policy">
        ...
        <p className="text-sm text-gray-800">
          Uygulamalarımızda verilen tüm servisler ve ürünler{" "}
          {sellerCompany.address} adresinde kayıtlı {sellerCompany.title}{" "}
        ...
        <p className="text-sm text-gray-800">
          Üyelik veya Uygulamalarımız üzerindeki çeşitli form ve anketlerin
          ...
          adresleri gibi) Uygulamalarımız tarafından işin doğası gereği
          toplanmaktadır.
        </p>
        <p className="text-sm text-gray-800">
        ...
        <p className="text-sm text-gray-800">
          Uygulamalarımız üzerinden veya eposta ile gerçekleştirilen onay
          sürecinde, üyelerimiz tarafından Uygulamalarımıza elektronik ortamdan
        ...
        <p className="text-sm text-gray-800">
          ...
          kullanıcı tarafından sağlanan bilgiler veya Uygulamalarımız üzerinden
          yapılan işlemlerle ilgili bilgiler; Firmamız ve işbirliği içinde
          olduğu kişiler tarafından, Üyelik Sözleşmesi ile belirlenen amaçlar ve
          kapsam dışında da, üyelerimizin kimliği ifşa edilmeden çeşitli
        ...
        <h2 className="text-xl font-bold text-gray-800">
          Mail Order ve Kredi Kartı Güvenliği
        </h2>
        <p className="text-sm text-gray-800">
        ...
        <p className="text-sm text-gray-800">
          Uygulamalarımız, web sitesi dâhilinde başka sitelere link verebilir.
          ...
          sözleşmedeki Gizlilik Politikası Prensipleri, sadece Uygulamalarımızın
          kullanımına ilişkindir, üçüncü taraf web sitelerini kapsamaz.
        </p>
        <h2 className="text-xl font-bold text-gray-800">İstisnai Haller</h2>
        <p className="text-sm text-gray-800">
        ...
        <p className="text-sm text-gray-800">
          2.Uygulamalarımızın kullanıcılarla akdettiği Üyelik Sözleşmesi
          &apos;nin ve diğer sözleşmelerin gereklerini yerine getirmek ve
        ...
        <h2 className="text-xl font-bold text-gray-800">E-Posta Güvenliği</h2>
        <p className="text-sm text-gray-800">
          Uygulamalarımızın Müşteri Hizmetleri’ne, herhangi bir siparişinizle
          ilgili olarak göndereceğiniz e-postalarda, asla kredi kartı numaranızı
          veya şifrelerinizi yazmayınız. E-postalarda yer alan bilgiler üçüncü
        ...
        <p className="text-sm text-gray-800">
          Firmamız, Uygulamalarımızı ziyaret eden kullanıcılar ve kullanıcıların
          web sitesini kullanımı hakkındaki bilgileri teknik bir iletişim
          dosyası Çerez-Cookie kullanarak elde edebilir. Bahsi geçen teknik
          iletişim dosyaları, ana bellekte saklanmak üzere bir internet
        ...
        <p className="text-sm text-gray-800">
          ...
          {sellerCompany.email} adresine email gönderebilirsiniz. Firmamız’a ait
          aşağıdaki iletişim bilgilerinden ulaşabilirsiniz.
        </p>
        <p className="text-sm text-gray-800">{sellerCompany.title}</p>
        <p className="text-sm text-gray-800">{sellerCompany.address}</p>
        <p className="text-sm text-gray-800">{sellerCompany.email}</p>
        <p className="text-sm text-gray-800">{sellerCompany.tel}</p>
        <p className="text-sm text-gray-800">{sellerCompany.mersis}</p>
        <p className="text-sm text-gray-800">{sellerCompany.tcVkn}</p>
      </div>
    </>
  );
};
