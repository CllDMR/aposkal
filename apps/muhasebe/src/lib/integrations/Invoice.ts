...
// type DocumentDescription = (typeof options)["DocumentDescription"][number];
type InvoiceTypeCode = (typeof options)["InvoiceTypeCode"][number];
type ProfileID = (typeof options)["ProfileID"][number];
...
export default class Invoice {
  ...
  LineCountNumeric: string | undefined;
